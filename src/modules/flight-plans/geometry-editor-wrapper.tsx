  ...
  () => import("@/modules/flight-plans/geometry-editor").then((m) => m.GeometryEditor),
  {
    ...
    loading: () => (
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_420px]">
        <div className="h-[560px] animate-pulse rounded-3xl border border-slate-800/80 bg-slate-950/45" />
        <div className="h-[600px] animate-pulse rounded-3xl border border-slate-800/80 bg-slate-950/45" />
      </div>
    ),
  },
);
