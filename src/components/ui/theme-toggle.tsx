...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-slate-700/80 bg-slate-900/80 text-sm transition hover:border-slate-600 hover:bg-slate-800"
