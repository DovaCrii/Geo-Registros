...
const FILTER_BAR_SHELL =
  "rounded-xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-950/45 p-5 shadow-sm dark:shadow-xl dark:shadow-slate-950/10";
const FILTER_BAR_GRID = "grid gap-4 sm:grid-cols-2 lg:grid-cols-4";
const FILTER_LABEL = "text-xs font-medium uppercase tracking-[0.18em] text-slate-600 dark:text-slate-400";
