...
- Mantener `AGENTS.md`, `documentacion/PROJECT_STATUS.md`, `documentacion/ROADMAP.md`, `documentacion/TASKS.md` y `documentacion/OPENCODE_HANDOFF.md` como contexto corto.
- Crear indice documental y bitacora de avance.
- Registrar decisiones tecnicas estables en `documentacion/DECISIONS.md`.
...
- Componentes en `apps/web/src/components/help-center/`: FlowMap, DocPreview, HelpCenterClient. ✅
...
- Separar perfiles operativos de perfiles de revisión/lectura en `apps/web/src/lib` y `apps/web/src/server`.
...
- Rediseñar el mapa como workspace integrado en `apps/web/src/modules/flight-plans/geometry-editor.tsx` con panel lateral más ordenado y herramientas más intuitivas.
