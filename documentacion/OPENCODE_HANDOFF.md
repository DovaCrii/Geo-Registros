...
3. `documentacion/ROADMAP.md`
4. `documentacion/TASKS.md`
5. `documentacion/OPENCODE_HANDOFF.md`
...
| **Home page** | Landing premium existente con 7 secciones en `apps/web/src/app/page.tsx`; sigue en polish |
...
## Alcance sugerido
- `backend/prisma/seed.cjs` — demo user, demo data refinada.
- `apps/web/src/app/page.tsx` — polish de hero, proof points, CTA.
- `README.md` — actualizar con stack real y valor comercial.
- `documentacion/ROADMAP.md`, `documentacion/TASKS.md`, `documentacion/PROJECT_STATUS.md` — mantener sincronizados.
...
## Prompt corto
Lee `AGENTS.md`, `documentacion/ROADMAP.md`, `documentacion/TASKS.md` y `documentacion/OPENCODE_HANDOFF.md`. Continuá con la fase comercial: refiná el seed demo, pulí la landing, actualizá el README premium y mantené los docs de seguimiento sincronizados. Validá con `npm run build` antes de commit.
