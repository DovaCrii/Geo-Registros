...
| T-029 | Empty states con acción contextual | Media ✅ | OpenCode | src/app/flight-plans/page.tsx, src/app/drones/page.tsx, src/app/clients/page.tsx, src/components/ui/list-page.tsx, src/components/ui/list-page-client.tsx | Ilustración + CTA + acción directa en módulos vacíos. | npm run typecheck ✅, npm run build ✅, revisión visual ✅ | 2h |
